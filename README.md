...
* [cite_start]**[Semana 4: Validación 4K](./Semana-4_Benchmarking4K):** Identificación del cuello de botella en alta resolución[cite: 91, 153].
...
## 🔬 Trabajo en Progreso (Fase de Mini-Paper)
Actualmente integrando comparativas con detectores Legacy (**SSD, Faster R-CNN**) y pruebas de **reconocimiento facial** para completar los requisitos de fin de grado.
